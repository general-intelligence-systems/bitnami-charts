...
```console
helm install my-release oci://ghcr.io/general-intelligence-systems/bitnami-charts/grafana-operator
```
...
extraDeploy:
  - apiVersion: integreatly.org/v1alpha1
    baseImage: ghcr.io/general-intelligence-systems/grafana:7
    kind: Grafana
    metadata:
      name: grafana
    spec:
...
image:
  registry: ghcr.io
  repository: general-intelligence-systems/grafana
  tag: 7.5.10
```
