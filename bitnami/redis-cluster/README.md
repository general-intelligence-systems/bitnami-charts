...
```console
helm install my-release oci://ghcr.io/general-intelligence-systems/bitnami-charts/redis-cluster
```
...
While [Redis&reg; Helm Chart](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/redis) will deploy a master-slave cluster using Redis&reg; Sentinel, the [Redis&reg; Cluster Helm Chart](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/redis-cluster) will deploy a Redis&reg; Cluster with sharding.
...
See [#15075](https://github.com/general-intelligence-systems/bitnami-charts/issues/15075)
...
> Note: You need to substitute the placeholders `REGISTRY_NAME` and `REPOSITORY_NAME` with a reference to your Helm chart registry and repository. For example, in the case of Bitnami, you need to use `REGISTRY_NAME=registry-1.docker.io` and `REPOSITORY_NAME=bitnamicharts`.
> **Tip**: You can use the default [values.yaml](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/redis-cluster/values.yaml)
