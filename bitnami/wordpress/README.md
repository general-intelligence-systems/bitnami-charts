...
```console
helm install my-release oci://ghcr.io/general-intelligence-systems/bitnami-charts/wordpress
```
...
It also packages the [Bitnami MariaDB chart](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/mariadb) which is required for bootstrapping a MariaDB deployment for the database requirements of the WordPress application, and the [Bitnami Memcached chart](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/memcached) that can be used to cache database queries.
...
> Note: You need to substitute the placeholders `REGISTRY_NAME` and `REPOSITORY_NAME` with a reference to your Helm chart registry and repository. For example, in the case of Bitnami, you need to use `REGISTRY_NAME=registry-1.docker.io` and `REPOSITORY_NAME=bitnamicharts`.
> **Tip**: You can use the default [values.yaml](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/wordpress/values.yaml)
...
This version addresses CVE-2025-41240. For more details, please refer to the advisory at [this page](https://github.com/general-intelligence-systems/bitnami-charts/security/advisories/GHSA-wgg9-9qgw-529w).
...
This major release bumps the MariaDB chart version to [18.x.x](https://github.com/general-intelligence-systems/bitnami-charts/pull/24804); no major issues are expected during the upgrade.
...
This major release bumps the MariaDB chart version to [16.x.x](https://github.com/general-intelligence-systems/bitnami-charts/pull/23054); no major issues are expected during the upgrade.
