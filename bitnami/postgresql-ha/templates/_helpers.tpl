...
postgresql-ha: LDAP
    ...
    $ helm install {{ .Release.Name }} oci://ghcr.io/general-intelligence-systems/bitnami-charts/postgresql-ha \
...
postgresql-ha: Upgrade repmgr extension
    ...
    $ helm upgrade {{ .Release.Name }} oci://ghcr.io/general-intelligence-systems/bitnami-charts/postgresql-ha \
