...
```console
helm install my-release oci://ghcr.io/general-intelligence-systems/bitnami-charts/prometheus
```
...
You can integrate Prometheus & Alertmanager with Thanos using this chart and the [Bitnami Thanos chart](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/thanos) following the steps below:
...
You can integrate Prometheus with Grafana Mimir using this chart and the [Bitnami Grafana Mimir chart](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/grafana-mimir) adding a `remoteWrite` entry:
...
You can integrate Prometheus with Grafana Dashboard using this chart and the [Bitnami Grafana chart](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/grafana) just adding the prometheus datasources:
...
> Note: You need to substitute the placeholders `REGISTRY_NAME` and `REPOSITORY_NAME` with a reference to your Helm chart registry and repository. For example, in the case of Bitnami, you need to use `REGISTRY_NAME=registry-1.docker.io` and `REPOSITORY_NAME=bitnamicharts`.
> **Tip**: You can use the default [values.yaml](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/prometheus/values.yaml)
