...
```console
helm install my-release oci://ghcr.io/general-intelligence-systems/bitnami-charts/parse
```
...
> Note: You need to substitute the placeholders `REGISTRY_NAME` and `REPOSITORY_NAME` with a reference to your Helm chart registry and repository. For example, in the case of Bitnami, you need to use `REGISTRY_NAME=registry-1.docker.io` and `REPOSITORY_NAME=bitnamicharts`.
> **Tip**: You can use the default [values.yaml](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/parse/values.yaml)
...
This major updates the MongoDB&reg; subchart to its newest major, [13.0.0](https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/mongodb#to-1300). No major issues are expected during the upgrade.
...
- <https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/mongodb#to-1200>
...
- <https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/mongodb#to-900>
...
- <https://github.com/general-intelligence-systems/bitnami-charts/tree/main/bitnami/mongodb#to-800>
